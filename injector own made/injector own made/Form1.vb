Public Class Form1
    ' hi that me source of injector basicly i just translate code for pasters maded by Neptuncio
...
ByVal hObject As Integer) As Integer
    ...
    Private Sub Inject()
        On Error GoTo 1 ' If error occurs, app will close without any errors
        Timer1.Stop()
...
1:      Me.Show()
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Timer1.Interval = 50
        Timer1.Start()
    End Sub ' how you see there are dll code about write for you informacions to add dlls, and browse for it

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        OpenFileDialog1.Filter = "DLL (*.dll) |*.dll"
        OpenFileDialog1.ShowDialog()
    End Sub ' theres type of file what kind of file you want to inject

    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        For i As Integer = (Dlls.SelectedItems.Count - 1) To 0 Step -1
            Dlls.Items.Remove(Dlls.SelectedItems(i))
        Next
    End Sub ' there are funcion of button 
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        Else
        End If
    End Sub ' there informacion about success of injecting 
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        Else
        End If
    End Sub ' theres some like in up 
...
' end of code injector made by neptuncio